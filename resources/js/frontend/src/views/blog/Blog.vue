            ...
            <div class="row justify-content-between">
                <div class="col-12 col-md-8 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
                    <div class="row g-5">
                        ...
                        <div v-for="(post) in items" :key="post.id" class="col-12">
                            <div class="card blog-card"><router-link :to="`/blog-detail/${post.id}`"><img class="card-img-top" :src="post.cover_image" alt=""></router-link>
