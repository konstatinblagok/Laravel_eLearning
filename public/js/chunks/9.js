...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_6__["mapGetters"])(['posts'])),
  methods: {
    ...
    formatDate: function formatDate(date) {
      return moment__WEBPACK_IMPORTED_MODULE_7___default()(date).format('MMM D, YYYY');
    }
  },
  mounted: function () {
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [_vm._v(_vm._s(_vm.formatDate(post.updated_at)))]
                          ),
                          _c(
                            "router-link",
                            {
